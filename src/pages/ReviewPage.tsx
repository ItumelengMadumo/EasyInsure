...
export function ReviewPage({ portfolio, groups, refresh, notify }: Props) {
  const queue = portfolio.claims.filter((claim) => claim.status === 'REVIEW');
